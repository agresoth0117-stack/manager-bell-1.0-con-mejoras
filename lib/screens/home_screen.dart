import 'schedules_weekly_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // 🔥 AQUÍ ESTA EL CAMBIO IMPORTANTE
      body: _index == 0
          ? _devicesList(deviceProv)
          : const SchedulesWeeklyScreen(),
  ...
  // 🔥 ESTA FUNCIÓN YA NO SE USA PERO LA DEJAMOS POR SI LA NECESITAS MÁS ADELANTE
